...
# Findroid
This is my fork of findroid where I have added the ability to chromecast media. currently I have only tested the Chromecast ultra (the one that looks like a hockey puck with a usb cable out of it).
