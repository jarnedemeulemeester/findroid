...
class DownloadHomeEpisodeListAdapter(private val onClickListener: OnClickListener) : ListAdapter<PlayerItem, DownloadHomeEpisodeListAdapter.EpisodeViewHolder>(DiffCallback) {
